...
export const en: Translations = {
  ...
  settings: {
    ...
    localModels: {
      ...
      vramUsed: (used, total) => `${used} / ${total} used`,
      vramFree: free => `${free} free`,
      vramEngine: label => `this engine ${label}`,
      vramOther: label => `other processes ${label}`,
      gpuDriver: version => `driver ${version}`,
      gpuCompute: cap => `compute ${cap}`,
      modelsPath: 'Model cache',
      storageUsed: (used, free) => `${used} on disk · ${free} free`,
      runtimePath: 'Runtime',
      engineStat: 'Engine',
      servingStat: 'Serving',
      servingReady: 'ready',
      servingStarting: 'starting',
      ctx64kFits: '64k context fits this GPU',
