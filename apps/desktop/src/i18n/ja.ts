...
export const ja = defineLocale({
  ...
  settings: {
    ...
    localModels: {
      ...
      vramUsed: (used, total) => `${used} / ${total} 使用中`,
      vramFree: free => `空き ${free}`,
      vramEngine: label => `このエンジン ${label}`,
      vramOther: label => `他プロセス ${label}`,
      gpuDriver: version => `ドライバ ${version}`,
      gpuCompute: cap => `コンピュート ${cap}`,
      modelsPath: 'モデルキャッシュ',
      ...
      servingReady: '準備完了',
      servingStarting: '起動中',
      ctx64kFits: 'この GPU は 64k コンテキストに対応',
